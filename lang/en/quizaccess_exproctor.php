...
$string['storage_method_description'] = 'Select how you want to store the proctoring evidence reports.';
$string['aws_region'] = 'Amazon Web Service region';
$string['aws_region_description'] = 'Select the AWS server region where S3 or Rekognition or both services are available.';
...
$string['screen_shot_width'] = 'The width of the screenshot image in px (pixels)';
$string['proctoring_method'] = 'Exam proctoring method';
$string['proctoring_method_help'] = 'How do you want to proctor this quiz? Please click the drop down to find Proctoring options.';
...
$string['webcam_proctoring_required_help'] = 'Do you want to use webcam proctoring for this quiz?';
$string['screen_proctoring_required'] = 'Screen proctoring';
$string['screen_proctoring_required_help'] = 'Do you want to use screen proctoring for this quiz?';
...
$string['frozen_message'] = 'This quiz already has attempts. Therefore ExProctor plugin settings can no longer be updated.';