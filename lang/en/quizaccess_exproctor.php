...
$string['settings:aws_access_key'] = 'Access key';
$string['settings:aws_access_key_description'] = 'Access key id for AWS.';
$string['settings:aws_secret_key'] = 'Secret key';
$string['settings:aws_secret_key_description'] = 'Secret key for AWS.';
