...
if ($hassiteconfig) {
    ...
    if ($ADMIN->fulltree) {
        try {
            ...
            $settings->add(new admin_setting_configtext("quizaccess_exproctor/awsaccesskey", get_string("settings:aws_access_key", "quizaccess_exproctor"), get_string("settings:aws_access_key_description", "quizaccess_exproctor"), null, PARAM_RAW_TRIMMED));

            $settings->add(new admin_setting_configtext("quizaccess_exproctor/awssecretkey", get_string("settings:aws_secret_key", "quizaccess_exproctor"), get_string("settings:aws_secret_key_description", "quizaccess_exproctor"), null, PARAM_RAW_TRIMMED));
